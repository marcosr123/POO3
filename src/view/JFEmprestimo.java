...
import ModeloDAO.DAOEmprestimo;
...
public class JFEmprestimo extends javax.swing.JFrame {  
    ...
    JFEmprestimo(TelaPrincipal telaPrincipal) {
        ...
        if (!(jTableEmprestimo.getSelectedRow() != -1)) {
            ...
            if (verificaDados()) {
                if (verificaDisponibilidadeLivro()) {
                    DAOEmprestimo d = new DAOEmprestimo();
                    if (!d.verificaMultaCliente(pegaIdCliente())) {
                        try {
                            ...
                            JOptionPane.showMessageDialog(rootPane, "Erro ao efetuar empréstimo."+ex);
                        }
                    } else {
    ...
    private void mostraPesquisaCliente(List<BeansCliente> clientes) {
        ...
        if (clientes.isEmpty()) {
            ...
            for (int i = 0; i < clientes.size(); i++) {
                ...
                tmCliente.setValueAt(clientes.get(i).getCodigo(), i, 0);
    ...
    List<BeansEmprestimo> emprestimos;
    ...
    // Mostra a lista de resultado de acordo com o nome passado no campo pesquisa
    private void mostraPesquisaEmprestimo(List<BeansEmprestimo> emprestimos) {
        // Limpa a tabela sempre que for solicitado uma nova pesquisa
        limpaTabelaEmprestimo();
    ...
    // Mostra a lista de resultado de acordo com o nome passado no campo pesquisa
    private void mostraPesquisaLivro(List<BeansLivro> livros) {
        // Limpa a tabela sempre que for solicitado uma nova pesquisa
        limpaTabelaLivro();
